...
import SelfPic from './Screenshot_20251118_195452_Instagram.jpg';

export default function About() {
  return (
    <div className="w-full min-h-screen bg-white pt-20 px-2 md:px-12">
      {/* First Row - ABOUT heading */}
      <h1 className="text-5xl sm:text-7xl md:text-8xl lg:text-9xl xl:text-[6rem] font-extrabold tracking-tight text-black leading-[0.95] mb-8">
        <span className="block">ABOUT</span>
      </h1>

      {/* Second Row - Two columns: ME and Description */}
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
        {/* Left Column - ME */}
        <div className="">
          <h1 className="text-5xl sm:text-7xl md:text-8xl lg:text-9xl xl:text-[6rem] font-extrabold tracking-tight leading-[0.95]">
            <span
        ...
        <div className="">
          <h2 className="text-xl md:text-2xl font-extrabold text-gray-800 mb-4">
            Digital Transformation & ERP Consultant
          </h2>
          <p className="text-sm md:text-[12px] text-gray-700 leading-relaxed">
      ...
      {/* Third Row - 3 Column Section (Address, Contact, Availability) */}
